...
func (ecu *ECUReaderInstance) readRawDataFrames() ([]byte, []byte, error) {
	...
	if dataframe7d, err = ecu.EcuReader.SendAndReceive(MEMSReqData7D); err != nil {
		if dferr != nil {
			...
			dataframe7d = []byte{0x7d, 0x20, 0x10, 0x0D, 0xff, 0x92, 0x00, 0x57, 0xff, 0xff, 0x01, 0x00, 0x64, 0x64, 0x00, 0xff, 0x00, 0xff, 0xff, 0x30, 0x00, 0x7b, 0x69, 0xff, 0x19, 0x40, 0x1e, 0xc0, 0x26, 0x40, 0x34, 0xc0, 0x00}
		}
	}
